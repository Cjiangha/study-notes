...
createComponent(
  createOptions({
    ...
    // components: {
    //   GoingCurrentLocationIcon,
    //   GoingUserCenterIcons,
    // },
    computed: {
      ...mapGetters("going", {
      ...
      btnClick() {
        if (this.taxiDefaultHandle) {
          ...
          if (gdServiceId === 5) {
            ...
            const endInfo = lodash.get(this.storeOrderDetail, "endInfo"); //远程特惠点击重新打车后跳转远程特惠运力
...
function createOptions(opts = {}) {
  opts.$renderKeys = ["__ready__", "__slotObj", "fontStyle", "btnText"];
  return opts;
}
